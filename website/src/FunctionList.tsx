...
import { prettyPercent, formatVirtualAddress } from "./helpers";
...
export function GithubLink(path: string): string {
  return (
    "https://github.com/LivewireCB/Hero-s-Tail-Decomp/blob/main/src/Gamecube/" +
    path.replace("main/", "") +
    ".cpp"
  );
}
  ...
  return (
    ...
    >
      ...
      <Text>
        ...
        / {formatVirtualAddress(fn.metadata?.virtual_address)} / size: {fn.size} / labels:{" "}
        {fn.labels}
      </Text>
